...
{
    public class BasicSorterPlus : MoveSorter
    {
        public BasicSorterPlus(IPosition position, IMoveComparer comparer) : base(position, comparer)
        {
        }

...
{
    public abstract class LmrEnrStrategyBase : LmrAnrStrategyBase
    {
        protected LmrEnrStrategyBase(short depth, IPosition position, TranspositionTable table = null) : base(depth, position, table)
        {
        }

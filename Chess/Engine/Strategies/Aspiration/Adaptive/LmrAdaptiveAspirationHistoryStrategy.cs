...
{
    public class LmrAdaptiveAspirationHistoryStrategy : AdaptiveAspirationStrategyBase
    {
        public LmrAdaptiveAspirationHistoryStrategy(short depth, IPosition position) : base(depth, position)
        {
        }

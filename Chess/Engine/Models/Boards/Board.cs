...
namespace Engine.Models.Boards
{
    public class Board : IBoard
    {
        ...
        public Board()
        {
            ...
            _notAbleCastleValue = _evaluationService.GetNotAbleCastleValue();
            _earlyQueenValue = _evaluationService.GetEarlyQueenValue();
            _doubleBishopValue = _evaluationService.GetDoubleBishopValue();
            _minorDefendedByPawnValue = _evaluationService.GetMinorDefendedByPawnValue();
            _blockedPawnValue = _evaluationService.GetBlockedPawnValue();
            _passedPawnValue = _evaluationService.GetPassedPawnValue();
            _doubledPawnValue = _evaluationService.GetDoubledPawnValue();
            _isolatedPawnValue = _evaluationService.GetIsolatedPawnValue();
            _backwardPawnValue = _evaluationService.GetBackwardPawnValue();
            _rookOnOpenFileValue = _evaluationService.GetRookOnOpenFileValue();
        }
        ...
        private int GetBlackValue()
        {
            ...
            return GetBlackPawnValue(pawns) + GetBlackKnightValue(knights) + GetBlackBishopValue(bishops) +
                   GetBlackRookValue(rooks) + GetBlackQueenValue(queens) + GetBlackKingValue();
        }
        ...
        private int GetBlackRookValue(int[] rooks)
        {
            ...
            return UpdateBlackRookValue(rooks, value);
        }
        ...
        private int GetBlackKnightValue(int[] knights)
        {
            ...
            for (var i = 0; i < knights.Length; i++)
            {
                ...
                {
                    value += _minorDefendedByPawnValue;
                }
            }
        ...
        private int GetBlackPawnValue(int[] positions)
        {
            ...
            for (var i = 0; i < positions.Length; i++)
            {
                ...
                {
                    value += _passedPawnValue;
                }

                pawns[file]++;
            }

            return GetPawnValue(value, _doubledPawnValue, _isolatedPawnValue, pawns);
        }
        ...
        private int GetWhiteValue()
        {
            ...
            return GetWhitePawnValue(pawns) + GetWhiteKnightValue(knights) + GetWhiteBishopValue(bishops) +
                   GetWhiteRookValue(rooks) + GetWhiteQueenValue(queens) + GetWhiteKingValue();
        }
        ...
        private int GetWhiteRookValue(int[] rooks)
        {
            ...
            return UpdateWhiteRookValue(rooks, value);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private int UpdateWhiteRookValue(int[] rooks, int value)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private int UpdateBlackRookValue(int[] rooks, int value)
        {
            for (var i = 0; i < rooks.Length; i++)
            {
                var rook = rooks[i].AsBitBoard();

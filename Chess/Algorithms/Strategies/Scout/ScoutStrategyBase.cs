...
{
    public class ScoutStrategyBase : AlphaBetaStrategyBase
    {
        protected int Iterations;
        public ScoutStrategyBase(short depth,int iterations, IMoveSorter sorter, IPosition position) : base(depth, sorter, position)
        {
